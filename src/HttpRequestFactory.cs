...
namespace R6DB_Bot
{
    public static class HttpRequestFactory
    {
        ...
        public static async Task<HttpResponseMessage> Get(string requestUri, string xAppId, List<KeyValuePair<string, string>> query, List<KeyValuePair<string, string>> headers)
        {
            ...
            return await builder.SendAsync(query, headers);
        }
        ...
        public static async Task<HttpResponseMessage> Post(
            string requestUri, object value, string xAppId)
        {
            var builder = new HttpRequestBuilder()
        ...
        public static async Task<HttpResponseMessage> Delete(
            string requestUri, string xAppId)
        {
            var builder = new HttpRequestBuilder()
        ...
        public static async Task<HttpResponseMessage> PostFile(string requestUri,
            string filePath, string apiParamName, string xAppId)
        {
            var builder = new HttpRequestBuilder()
                                .AddMethod(HttpMethod.Post)
                                .AddRequestUri(requestUri)
